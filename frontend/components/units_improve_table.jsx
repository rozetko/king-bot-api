...
export default connect(storeKeys)(props => {
	...
	const list = content.map(item =>
		<UnitType content={ item } remove_unit={ remove_unit } edit_unit={ edit_unit } props={ props } />
	);
...
const UnitType = ({ content, remove_unit, edit_unit, props }) => (
	<tr>
		<td style={ rowStyle }>
		...
		<td style={ rowStyle }>
			{content.level == -1  ? props.lang_common_max : content.level }
		</td>
		<td style={ rowStyle }>
